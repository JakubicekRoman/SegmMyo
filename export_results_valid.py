...
data_list_2_train, data_list_2_test, data_list_3_train = Loaders_2.CreateDataset_div()
...
# path_save = '/data/rj21/MyoSeg/valid/export_valid/cine'
# path_save = '/data/rj21/MyoSeg/valid/export_valid/Joint_T2'
path_save = '/data/rj21/MyoSeg/valid/export_valid/Clinic_T2'
...
# for num in ind:
    ...
    Fig.savefig( path_save + '/' + 'img_' + '_' +  nPat + file_name.split('_')[0] + '_' + seq + '_' + str(current_index) + version + '.png', dpi=150)
    ...
    savemat(  path_save + '/' + 'res_' +  nPat + file_name.split('_')[0] + '_' + seq + '_' + str(current_index) + version + '.mat', mdic)
